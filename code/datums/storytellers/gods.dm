...
/datum/storyteller/psydon
	...
	//wretch_slot_cap = 0 // OV Remove: We don't want storytellers limiting wretches here!
...
/datum/storyteller/eora
	...
	color_theme = "#9966CC"
	preferred_gnoll_mode = GNOLL_SCALING_NONE
	//wretch_slot_cap = 5 // OV Remove: We don't want storytellers limiting wretches here!
	guarantees_roundstart_roleset = FALSE
	roundstart_prob = 0
...
/datum/storyteller/zizo
	...
	//wretch_slot_cap = 15 // OV Remove: We don't want storytellers limiting wretches here!
