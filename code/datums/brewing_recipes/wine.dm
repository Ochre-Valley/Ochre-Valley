...
/datum/brewing_recipe/winespiced
	...
	needed_crops = list(/obj/item/reagent_containers/food/snacks/grown/berries/rogue = 2, /obj/item/reagent_containers/food/snacks/grown/fruit/tangerine = 1,
						/obj/item/reagent_containers/food/snacks/sugar = 1, /obj/item/reagent_containers/food/snacks/roastseeds/pumpkin = 1, /obj/item/reagent_containers/food/snacks/grown/nut = 1) //Ochre edit. Roasted pumpkin seeds, not pumpkin spice. /reagent_container/powder is not a valid type for brewing ingredients.
	brewed_amount = 5
	brew_time = 5 MINUTES
