...
/datum/antagonist/bandit
	...
	storyteller_slot_scaling = 0 // OV Edit - 2
	storyteller_slot_default_cap = 0 // OV Edit - 2
	storyteller_maxcaps = list(
		/datum/storyteller/gamemode/guaranteed_antag = 0, //OV Edit - 4
		/datum/storyteller/gamemode/guaranteed_antag/low_wretch = 0, //OV Edit - 6
	)
	var/favor = 150
	var/totaldonated = 0
