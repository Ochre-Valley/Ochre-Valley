...
/mob/living/carbon/human/species/human/northern/doppelganger/after_creation()
	...
	adjust_skillrank(/datum/skill/combat/polearms, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/maces, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/axes, 4, TRUE)
	...
	adjust_skillrank(/datum/skill/combat/knives, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/whipsflails, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/bows, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/crossbows, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/staves, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/slings, 4, TRUE)
	adjust_skillrank(/datum/skill/combat/firearms, 4, TRUE)
	adjust_skillrank(/datum/skill/misc/climbing, 3, TRUE)
	adjust_skillrank(/datum/skill/misc/swimming, 3, TRUE)
	update_hair()
	update_body()
